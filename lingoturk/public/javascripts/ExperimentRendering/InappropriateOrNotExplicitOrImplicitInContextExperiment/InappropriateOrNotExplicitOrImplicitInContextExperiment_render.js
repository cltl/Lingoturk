(function () {
    var app = angular.module('InappropriateOrNotExplicitOrImplicitInContextExperimentApp', ["Lingoturk"]);
...
this.submitResults = function (successCallback, errorCallback) {
    var results = {
        experimentType : "InappropriateOrNotExplicitOrImplicitInContextExperiment",
