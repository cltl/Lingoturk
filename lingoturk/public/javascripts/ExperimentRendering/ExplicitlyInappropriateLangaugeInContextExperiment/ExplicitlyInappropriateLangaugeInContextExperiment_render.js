(function () {
    var app = angular.module('ExplicitlyInappropriateLangaugeInContextExperimentApp', ["Lingoturk"]);
...
this.submitResults = function (successCallback, errorCallback) {
    var results = {
        experimentType : "ExplicitlyInappropriateLangaugeInContextExperiment",
