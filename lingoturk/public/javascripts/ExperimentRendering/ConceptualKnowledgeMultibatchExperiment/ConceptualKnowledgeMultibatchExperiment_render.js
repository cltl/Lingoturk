(function () {
    var app = angular.module('ConceptualKnowledgeMultibatchExperimentApp', ["Lingoturk"]);
    ...
    app.controller('RenderController', ['$http', '$timeout', '$scope', function ($http, $timeout, $scope) {
        ...
        // use this after every question (perhaps we do not need this)
        ...
        this.nextSublist = function(){
            // set questions index to 0
            self.questionIndex = 0;
            //use next sublist at first index (old one was removed)
